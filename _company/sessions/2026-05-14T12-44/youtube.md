...
Traceback (most recent call last):
  File "c:\9jeonplus-ai\_company\_agents\youtube\tools\my_videos_check.py", line 478, in <module>
    main()
    ~~~~^^
  File "c:\9jeonplus-ai\_company\_agents\youtube\tools\my_videos_check.py", line 135, in main
...
������ YouTube ���� / ä�� ���� ������
  ...
  �м� ��          : (�ڵ� ����)
Traceback (most recent call last):
  File "c:\9jeonplus-ai\_company\_agents\youtube\tools\youtube_account.py", line 46, in <module>
    main()
    ~~~~^^
  File "c:\9jeonplus-ai\_company\_agents\youtube\tools\youtube_account.py", line 40, in main
    print("\n\u26a0\ufe0f  API Ű�� ����־��. �ٸ� �������� �������� �ʽ��ϴ�.")
    ~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
